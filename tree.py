...
class Tree(object):
    ...
    def breadth_first_search(self, data):
        ...
        # while there is data
        while to_visit:
            # pop off at the beginning rather than the end, using a queue
            current = to_visit.pop(0)

            # if it matches what you're looking for, return that
            if current.data == data:
                return current

            # otherwise, keep searching and add the node's children 
            # to the list of stuff to search
